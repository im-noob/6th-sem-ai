...
public class Profile extends JFrame implements Runnable{
	...
	private void initialComponent() {
        ...
        jLabelName.setText("Project By- BCA VIth SEM STUDENT");
        jLabelName.setToolTipText("Developer");
        jLabelName.setBounds(20, 60, 290, 20);

        jLabelInstitute.setFont(new java.awt.Font("Lucida Bright", 2, 15)); // NOI18N
        jLabelInstitute.setText("TMBU Univercity Bhagalpur");
        jLabelInstitute.setToolTipText("Univercity");
        ...
        jLabelEmail.setText("Subject-Artificial-Intelligenc");
        ...
        jTextAreaInformation.setText("  We are very thankful to all the teachers and my friends to help to make this project ");
        jTextAreaInformation.setToolTipText("Thanks Note");
